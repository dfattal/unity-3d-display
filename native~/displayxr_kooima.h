...
XrFovf displayxr_compute_kooima_fov(XrVector3f eye_pos, float screen_width_m, float screen_height_m);
...
void displayxr_apply_scene_transform(const XrVector3f *raw_left,
...
void displayxr_apply_tunables(const XrVector3f *raw_left,
                             const XrVector3f *raw_right,
...
void displayxr_camera_centric_extents(float convergence_distance,
                                     float fov_override,
                                     const DisplayXRDisplayInfo *display_info,
                                     float *out_width,
                                     float *out_height);

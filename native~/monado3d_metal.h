...
int monado3d_metal_create_shared_surface(uint32_t width, uint32_t height);

/// Release the shared IOSurface.
void monado3d_metal_destroy_shared_surface(void);

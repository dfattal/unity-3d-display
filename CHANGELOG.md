...
All notable changes to the Monado 3D Display Unity plugin will be documented in this file.
...
- OpenXR Feature lifecycle (`Monado3DFeature`) with native hook chain
- Camera-centric stereo rig (`Monado3DCamera`) for retrofitting existing scenes
- Display-centric stereo rig (`Monado3DDisplay`) for virtual display placement
...
- 2D UI overlay component (`Monado3DWindowSpaceUI`) for HUDs and menus
